defmodule <%= base %>.RegistrationController do
  ...
  plug Curator.Plug.EnsureNotAuthenticated, %{ handler: <%= base %>.ErrorHandler } when action in [:new, :create]
  plug Curator.Plug.EnsureResourceAndSession, %{ handler: <%= base %>.ErrorHandler } when action in [:show, :edit, :update, :delete]
